...
public interface LhQuestionDao{
	...
	@Sql("SELECT lq.id,lq.subject,lq.type,lq.choose_answer,lq.right_answer,lq.analysis FROM lh_exam_question leq left join lh_question lq on leq.question_id = lq.id WHERE leq.exam_id = :examId")
