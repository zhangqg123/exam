...
import com.jeecg.exam.util.ContextHolderUtils;
import com.jeecg.exam.util.ImageUtil;
 ...
 */
@Controller
@RequestMapping("/jeecg/examUpload")
public class ExamUploadController extends BaseController{
